...
public class ExpensesLast5MinKS {

    public static final String INPUT_TOPIC = KafkaShop.SHIPMENTS_TOPIC;
    public static final String TABLE_NAME = "table-expenses-last-5-min";
    ...
    public static void startKafkaStream() throws Exception {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "expenses-table-last-5-min");
