...
public class ExpensesKS {

    public static final String INPUT_TOPIC = KafkaShop.SHIPMENTS_TOPIC;
    public static final String TABLE_NAME = "table-expenses";
    ...
    public static void startKafkaStream() throws Exception {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "expenses-table");
